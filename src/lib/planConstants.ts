export const RAW_PLAN_DATA: string[][] = [
  ...
  ['Genesis 48', 'Luke 1:39ff', 'Job 14', '1 Corinthians 2'],
  ...
  ['Exodus 11-12:21', 'Luke 14', 'Job 29', '1 Corinthians 15'],
  ['Exodus 12:22ff', 'Luke 15', 'Job 30', '1 Corinthians 16'],
  ...
  ['Numbers 19', 'Psalms 56-57', 'Isaiah 8-9:7', 'James 2'],
  ['Numbers 20', 'Psalms 58-59', 'Isaiah 9:8-10:4', 'James 3'],
  ['Numbers 21', 'Psalms 60-61', 'Isaiah 10:5ff', 'James 4'],
  ...
  ['Numbers 34', 'Psalms 78:38ff', 'Isaiah 26', '1 John 4'],
  ...
  ['Deuteronomy 27-28:19', 'Psalms 119:1-24', 'Isaiah 54', 'Matthew 2'],
  ['Deuteronomy 28:20ff', 'Psalms 119:25-48', 'Isaiah 55', 'Matthew 3'],
  ...
  ['Joshua 6:6ff', 'Psalms 135-136', 'Isaiah 66', 'Matthew 14'],
  ...
  ['Judges 10-11:11', 'Acts 14', 'Jeremiah 23', 'Mark 9'],
  ['Judges 11:12ff', 'Acts 15', 'Jeremiah 24', 'Mark 10'],
  ...
  ['2 Samuel 23', 'Galatians 3', 'Ezekiel 30', 'Psalms 78:38ff'],
  ...
  ['1 Chronicles 9-10', 'Hebrews 12', 'Amos 6', 'Luke 1:39ff'],
  ...
  ['2 Chronicles 6:12ff', '1 John 5', 'Habakkuk 1', 'Luke 20'],
  ...
  ['2 Chronicles 31', 'Revelation 17', 'Zechariah 13:2ff', 'John 16'],
  ...
  for (const year of [startYear, startYear + 1]) {
    if (isLeapYear(year)) {
      ...
      if (diffDays >= 0 && diffDays < 365) {
        ...
        const d = new Date(startDate.getTime() + diffDays * DAY_IN_SECONDS * 1000);
